...
export const Footer = () => {
    return (
        <footer className="bg-white px-6 py-4 border-t-2 flex justify-center">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-5 justify-items-center">
                ...
                <div className="text-center space-y-2">
                    <a href="/acknowledgements" className="block text-center hover:underline">Acknowledgements</a>
